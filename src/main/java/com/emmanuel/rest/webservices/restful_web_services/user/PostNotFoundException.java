...
public class PostNotFoundException extends RuntimeException {
    public PostNotFoundException(String message) {
        // This constructor is used to create a new PostNotFoundException object with a message
        //How is the error  being generated?
        //The PostNotFoundException class extends the RuntimeException class which is used to create a custom exception
